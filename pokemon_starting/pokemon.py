...
if __name__ == '__main__':
    ...
    bleh = input()
    time.sleep(1.5)
    delay_print('\nI\'m sorry! My hearing is not what used to be. Would you mind repeating that.\n')
    player.name = input()
    delay_print('\nOh {0}. That\'s such a nice name.'.format(player.name))
    time.sleep(1.5)
    delay_print('\nYour very own POKEMON legend is about to unfold!')
    time.sleep(1.5)
    delay_print('\nA world of dreams and adventures with POKEMON awaits! Let\'s go!')
    time.sleep(1.5)
    delay_print('\nOh, right. Before we start, you might need some POKEMON. I hope you brought your own.')
    ...
    time.sleep(1.5)
    delay_print('\nI had some Pokeballs laying somewhere around here, oh nevermind.')
    time.sleep(1.5)
    delay_print('\nAh great! I see you have some with you. Let\'s begin then!')
    time.sleep(1.5)
    playing = True
    while playing:
        ...
        if (choice == '1'):
            ...
            playing = False
    delay_print('You completed {0}% of your Pokedex. That\'s good enough for today.'.format(random.randint(0, 15) * 0.1))
